...
export const PROVIDERS = {
  anthropic: {
    ...
    id: 'anthropic',
    models: [
      { id: 'claude-opus-4-6', name: 'Claude Opus 4.6', supportsImages: true, maxTokens: 32000 },
      { id: 'claude-opus-4-5-20251101', name: 'Claude Opus 4.5', supportsImages: true, maxTokens: 32000 },
      { id: 'claude-sonnet-4-5-20250929', name: 'Claude Sonnet 4.5', supportsImages: true, maxTokens: 64000 },
      { id: 'claude-haiku-4-5-20251001', name: 'Claude Haiku 4.5', supportsImages: true, maxTokens: 8192 },
    ],
  ...
  openai: {
    ...
    models: [
      ...
      { id: 'gpt-5-nano', name: 'GPT-5 Nano', supportsImages: true, maxTokens: 16384, noTemperature: true },
      // Reasoning Models
