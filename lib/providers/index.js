...
export const PROVIDERS = {
  anthropic: {
    ...
    id: 'anthropic',
    models: [
      { id: 'claude-opus-4-7', name: 'Claude Opus 4.7', supportsImages: true, maxTokens: 32000, isLatest: true, supportsWebSearch: true, supportsMath: true },
      { id: 'claude-opus-4-6', name: 'Claude Opus 4.6', supportsImages: true, maxTokens: 32000, supportsWebSearch: true, supportsMath: true },
      { id: 'claude-sonnet-4-6', name: 'Claude Sonnet 4.6', supportsImages: true, maxTokens: 64000, supportsWebSearch: true, supportsMath: true },
      { id: 'claude-opus-4-5-20251101', name: 'Claude Opus 4.5', supportsImages: true, maxTokens: 32000, supportsWebSearch: true, supportsMath: true },
      { id: 'claude-sonnet-4-5-20250929', name: 'Claude Sonnet 4.5', supportsImages: true, maxTokens: 64000, supportsWebSearch: true, supportsMath: true },
      { id: 'claude-haiku-4-5-20251001', name: 'Claude Haiku 4.5', supportsImages: true, maxTokens: 8192, supportsWebSearch: true, supportsMath: true },
    ],
  ...
  openai: {
    ...
    models: [
      // GPT-5 Series (Latest)
      { id: 'gpt-5.4', name: 'GPT-5.4', supportsImages: true, maxTokens: 128000, isLatest: true, supportsMath: true },
      { id: 'gpt-5.2', name: 'GPT-5.2', supportsImages: true, maxTokens: 32768, supportsMath: true },
      { id: 'gpt-5-mini', name: 'GPT-5 Mini', supportsImages: true, maxTokens: 32768, supportsMath: true },
      { id: 'gpt-5-nano', name: 'GPT-5 Nano', supportsImages: true, maxTokens: 16384, noTemperature: true, supportsMath: true },
      // Reasoning Models
      { id: 'o4-mini', name: 'o4-mini (Reasoning)', supportsImages: true, maxTokens: 65536, isReasoning: true, supportsMath: true },
      { id: 'o3', name: 'o3 (Reasoning)', supportsImages: true, maxTokens: 65536, isReasoning: true, supportsMath: true },
      // GPT-4 Series (Legacy but still good)
      { id: 'gpt-4.1', name: 'GPT-4.1', supportsImages: true, maxTokens: 32768, supportsMath: true },
      { id: 'gpt-4o', name: 'GPT-4o', supportsImages: true, maxTokens: 16384, supportsMath: true },
      { id: 'gpt-4o-mini', name: 'GPT-4o Mini', supportsImages: true, maxTokens: 16384, supportsMath: true },
      // Web Search Models (dedicated search models for Chat Completions)
      { id: 'gpt-5-search-api', name: 'GPT-5 Search', supportsImages: true, maxTokens: 32768, supportsWebSearch: true, supportsMath: true },
      { id: 'gpt-4o-search-preview', name: 'GPT-4o Search', supportsImages: true, maxTokens: 16384, supportsWebSearch: true },
      { id: 'gpt-4o-mini-search-preview', name: 'GPT-4o Mini Search', supportsImages: true, maxTokens: 16384, supportsWebSearch: true },
    ],
